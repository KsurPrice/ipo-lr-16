...
def about(request):
    ...
    <!DOCTYPE html>
    <html>
    <head><title>Об авторе</title><meta charset="UTF-8"></head>
    <body style="font-family: Arial; text-align: center; margin-top: 50px;">
        <h1>📖 Об авторе</h1>
        <p><strong>ФИО:</strong> Карась Илья</p>
...
def store_info(request):
    ...
    <!DOCTYPE html>
    <html>
    <head><title>О магазине</title><meta charset="UTF-8"></head>
    <body style="font-family: Arial; text-align: center; margin-top: 50px;">
        <h1>🏪 О магазине</h1>
        <p><strong>Тема:</strong> Магазин аксессуаров для велосипедов</p>
        <p><strong>Товары:</strong> фонари, замки, сумки, шлемы, инструменты</p>
        <a href="/">← На главную</a>
    </body>
    </html>
    """
